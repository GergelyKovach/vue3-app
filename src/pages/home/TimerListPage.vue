                ...
                <div class="list-element" v-for="timer in timersObjs" v-bind:key="timer.uuid">
                    ...
                    <div class="task-controller">
                        <v-row>
                            ...
                            <v-col cols="1">
                                <v-checkbox class="checkbox-finished" v-model="timer.finished"></v-checkbox>
                            </v-col>
                            <v-col>
                                ...
                                <v-chip-group>
                                    ...
                                    <v-chip v-for="tag in timer.tags" class="chip" color="primary" close="1">{{
                                        tag
                                    }}</v-chip>
                                </v-chip-group>
                            </v-col>
                            <v-col cols="2">
                                <div class="formatted-time-left">{{ timer.countdownFrom }}</div>
                                <!-- we need a component to select hour, minute and seconds and return the amount in seconds  -->
                                <time-selector v-model="timer.countdownFrom"></time-selector>
                                <div class="formatted-time-spent">{{ timer.timeSpentFormatted }}</div>
                                <!-- <div class="formatted-time-spent">{{ timer.timeLeftFormatted }}</div> -->
                            </v-col>
                            <v-col cols="1">
                                <v-btn icon :plain="true" class="mr-5 fullscreen-control-button" width="5rem"
